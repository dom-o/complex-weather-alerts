...
from alerts.core_data import datapoint_schema, unwanted
...
class Filter(models.Model):
    WEATHER_OPTION_CHOICES = tuple((k, v['title']) for k,v in datapoint_schema['properties'].items() if k not in unwanted) 
