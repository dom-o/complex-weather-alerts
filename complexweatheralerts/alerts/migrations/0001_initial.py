# Generated by Django 2.2.3 on 2019-07-02 03:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('compare_option', models.CharField(choices=[('exactly', 'exactly'), ('between', 'between'), ('more', 'more than'), ('less', 'less than')], max_length=7)),
        ...
        migrations.AddField(
            model_name='filter',
            name='number_data',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='filter', to='alerts.NumberData'),
        ),
        migrations.AddField(
            model_name='filter',
            name='string_data',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='filter', to='alerts.StringData'),
        ),
        migrations.AddField(
            model_name='alert',
            name='location',
        ...
        migrations.AddConstraint(
            model_name='filter',
            constraint=models.CheckConstraint(check=models.Q(('string_data__isnull', False), ('number_data__isnull', False), _connector='OR'), name='string data or num data not null'),
        ),
